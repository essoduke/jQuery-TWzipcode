...
"\u671b\u5b89\u9109":"882","\u4e03\u7f8e\u9109":"883","\u767d\u6c99\u9109":"884","\u6e56\u897f\u9109":"885"},"\u5357\u6d77\u8af8\u5cf6":{"\u6771\u6c99":"817","\u5357\u6c99":"819"}};m.prototype={VERSION:"1.6.2",data:function(){var b=this.wrap;return l(e,b.county.val())?e[b.county.val()]:e},serialize:function(){var b=[],a={},c={},h={},a=this.container.find("select,input");a.length?a.each(function(){h=f(this);b.push(h.attr("name")+"="+h.val())}):f(this).children().each(function(){c=f(this);b.push(c.attr("name")+
"="+c.val())});return b.join("&")},destroy:function(){f.data(this.container.get(0),"twzipcode",null);if(this.container.length)return this.container.empty().off("change keyup blur")},reset:function(b,a){var c=this.wrap,h=['<option value="">\u7e23\u5e02</option>','<option value="">\u9109\u93ae\u5e02\u5340</option>'],d=[],g;switch(a){case "district":c.district.empty().html(h[1]);break;default:c.county.empty().html(h[0]);c.district.empty().html(h[1]);for(g in e)l(e,g)&&(d.push('<option value="'),d.push(g),
d.push('">'),d.push(g),d.push("</option>"));f(d.join("")).appendTo(c.county)}c.zipcode.val("")},bindings:function(){var b=this,a=b.options,c=b.wrap;c.county.on("change",function(){var h=f(this).val(),d=[],g;c.district.empty();if(h){for(g in e[h])l(e[h],g)&&(d.push('<option value="'),d.push(g),d.push('">'),d.push(g),d.push("</option>"));c.district.append(d.join("")).trigger("change")}else c.county.find("option:first").prop("selected",!0),b.reset("district");"function"===typeof a.onCountySelect&&a.onCountySelect.call(this,
c.county)});c.district.on("change",function(){var b=f(this).val();c.county.val()&&c.zipcode.val(e[c.county.val()][b]);"function"===typeof a.onDistrictSelect&&a.onDistrictSelect.call(this,c.district)});c.zipcode.on("keyup blur",function(){var b=f(this),d="",g,k;b.val(b.val().replace(/[^0-9]/g,""));d=b.val().toString();if(3===d.length)for(g in e)if(l(e,g))for(k in e[g])if(l(e[g],k)&&d===e[g][k]){c.county.val(g).trigger("change");c.district.val(k).trigger("change");break}"function"===typeof a.onZipcodeKeyUp&&
a.onZipcodeKeyUp.call(this,c.zipcode)});l(e,a.countySel)&&(this.wrap.county.val(a.countySel).trigger("change"),l(e[a.countySel],a.districtSel)&&this.wrap.district.val(a.districtSel).trigger("change"));a.zipcodeSel&&3===a.zipcodeSel.toString().length&&this.wrap.zipcode.val(a.zipcodeSel).trigger("blur")},geolocation:function(){},init:function(){var b=this.container,a=this.options,c=b.find('[data-role="county"]:first'),e=b.find('[data-role="district"]:first'),d=b.find('[data-role="zipcode"]:first');
f("<select/>").attr("name",a.countyName).addClass(c.data("style")||(k!==a.css[0]?a.css[0]:"")).appendTo(c.length?c:b);f("<select/>").attr("name",a.districtName).addClass(e.data("style")||(k!==a.css[1]?a.css[1]:"")).appendTo(e.length?e:b);f("<input/>").attr({type:"text",name:a.zipcodeName}).prop("readonly",a.readonly).addClass(d.data("style")||(k!==a.css[2]?a.css[2]:"")).appendTo(d.length?d:b);this.wrap={county:b.find('select[name="'+a.countyName+'"]:first'),district:b.find('select[name="'+a.districtName+
'"]:first'),zipcode:b.find('input[type=text][name="'+a.zipcodeName+'"]:first')};this.reset();this.bindings();this.geolocation()}};f.fn.twzipcode=function(b){if("string"===typeof b){switch(b){case "data":case "destroy":case "reset":case "serialize":var a,c;this.each(function(){c=f.data(this,"twzipcode");c instanceof m&&"function"===typeof c[b]&&(a=c[b].apply(c,Array.prototype.slice.call(arguments,1)))})}return k!==a?a:this}return this.each(function(){f.data(this,"twzipcode")||f.data(this,"twzipcode",
new m(this,b))})}})(jQuery,window,document);
