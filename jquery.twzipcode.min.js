...
"\u671b\u5b89\u9109":"882","\u4e03\u7f8e\u9109":"883","\u767d\u6c99\u9109":"884","\u6e56\u897f\u9109":"885"},"\u5357\u6d77\u8af8\u5cf6":{"\u6771\u6c99":"817","\u5357\u6c99":"819"}};n.prototype={VERSION:"1.6.3",data:function(){var a=this.wrap;return k(d,a.county.val())?d[a.county.val()]:d},serialize:function(){var a=[],c={},b={},d={},c=this.container.find("select,input");c.length?c.each(function(){b=f(this);a.push(b.attr("name")+"="+b.val())}):f(this).children().each(function(){d=f(this);a.push(d.attr("name")+
"="+d.val())});return a.join("&")},destroy:function(){f.data(this.container.get(0),"twzipcode",null);if(this.container.length)return this.container.empty().off("change keyup blur")},reset:function(a,c){var b=this.wrap,g={},e=['<option value="">\u7e23\u5e02</option>','<option value="">\u9109\u93ae\u5e02\u5340</option>'],h=[];switch(c){case "district":b.district.empty().html(e[1]);break;default:b.county.empty().html(e[0]);b.district.empty().html(e[1]);for(g in d)k(d,g)&&(h.push('<option value="'+g+
'">'),h.push(g),h.push("</option>"));f(h.join("")).appendTo(b.county)}b.zipcode.val("")},bindings:function(){var a=this,c=a.options,b=a.wrap,g="",e="",h="";b.county.on("change",function(){var g=f(this).val(),e={},m=[];b.district.empty();if(g){for(e in d[g])k(d[g],e)&&(m.push('<option value="'+e+'">'),m.push(e),m.push("</option>"));b.district.append(m.join("")).trigger("change")}else b.county.find("option:first").prop("selected",!0),a.reset("district");"function"===typeof c.onCountySelect&&c.onCountySelect.call(this,
b.county)});b.district.on("change",function(){var a=f(this).val();b.county.val()&&b.zipcode.val(d[b.county.val()][a]);"function"===typeof c.onDistrictSelect&&c.onDistrictSelect.call(this,b.district)});b.zipcode.on("keyup blur",function(){var a=f(this),g="",e=0,h=0;a.val(a.val().replace(/[^0-9]/g,""));g=a.val().toString();if(3===g.length)for(e in d)if(k(d,e))for(h in d[e])if(k(d[e],h)&&g===d[e][h]){b.county.val(e).trigger("change");b.district.val(h).trigger("change");break}"function"===typeof c.onZipcodeKeyUp&&
c.onZipcodeKeyUp.call(this,b.zipcode)});g=l!==a.role.zipcode.data("value")?a.role.zipcode.data("value"):k(d,c.countySel)?c.countySel:"";e=l!==a.role.county.data("value")?a.role.county.data("value"):k(d,c.countySel)?c.countySel:"";h=l!==a.role.district.data("value")?a.role.district.data("value"):k(d,c.districtSel)?c.districtSel:"";e&&(a.wrap.county.val(e).trigger("change"),k(d[e],h)&&a.wrap.district.val(h).trigger("change"));g&&3===g.toString().length&&a.wrap.zipcode.val(g).trigger("blur")},geolocation:function(){},
init:function(){var a=this.container,c=this.options,b={county:a.find('[data-role="county"]:first'),district:a.find('[data-role="district"]:first'),zipcode:a.find('[data-role="zipcode"]:first')};f("<select/>").attr("name",c.countyName).addClass(b.county.data("style")||(l!==c.css[0]?c.css[0]:"")).appendTo(b.county.length?b.county:a);f("<select/>").attr("name",c.districtName).addClass(b.district.data("style")||(l!==c.css[1]?c.css[1]:"")).appendTo(b.district.length?b.district:a);f("<input/>").attr({type:"text",
name:c.zipcodeName}).prop("readonly",c.readonly).addClass(b.zipcode.data("style")||(l!==c.css[2]?c.css[2]:"")).appendTo(b.zipcode.length?b.zipcode:a);this.wrap={county:a.find('select[name="'+c.countyName+'"]:first'),district:a.find('select[name="'+c.districtName+'"]:first'),zipcode:a.find('input[type=text][name="'+c.zipcodeName+'"]:first')};this.role=b;this.reset();this.bindings();this.geolocation()}};f.fn.twzipcode=function(a){if("string"===typeof a){switch(a){case "data":case "destroy":case "reset":case "serialize":var c,
b;this.each(function(){b=f.data(this,"twzipcode");b instanceof n&&"function"===typeof b[a]&&(c=b[a].apply(b,Array.prototype.slice.call(arguments,1)))})}return l!==c?c:this}return this.each(function(){f.data(this,"twzipcode")||f.data(this,"twzipcode",new n(this,a))})}})(jQuery,window);
