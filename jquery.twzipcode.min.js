...
"="+c.val())});return b.join("&")},destroy:function(){f.data(this.container,"twzipcode",null);this.container.length&&this.container.empty().off("change keyup blur").remove()},reset:function(b,a){var c=this.wrap,h=['<option value="">\u7e23\u5e02</option>','<option value="">\u9109\u93ae\u5e02\u5340</option>'],d=[],g;switch(a){case "district":c.district.empty().html(h[1]);break;default:c.county.empty().html(h[0]);c.district.empty().html(h[1]);for(g in e)l(e,g)&&(d.push('<option value="'),d.push(g),d.push('">'),
d.push(g),d.push("</option>"));f(d.join("")).appendTo(c.county)}c.zipcode.val("")},bindings:function(){var b=this,a=b.options,c=b.wrap;c.county.on("change",function(){var h=f(this).val(),d=[],g;c.district.empty();if(h){for(g in e[h])l(e[h],g)&&(d.push('<option value="'),d.push(g),d.push('">'),d.push(g),d.push("</option>"));c.district.append(d.join("")).trigger("change")}else c.county.find("option:first").prop("selected",!0),b.reset("district");"function"===typeof a.onCountySelect&&a.onCountySelect.call(this,
