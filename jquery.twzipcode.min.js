...
"\u897f\u5dbc\u9109":"881","\u671b\u5b89\u9109":"882","\u4e03\u7f8e\u9109":"883","\u767d\u6c99\u9109":"884","\u6e56\u897f\u9109":"885"}};l.prototype={VERSION:"1.7.11",data:function(){var a=this.wrap;return"undefined"!==typeof e[a.county.val()]?e[a.county.val()]:e},serialize:function(){var a=[],b={},c={},e={},b=this.container.find("select,input");b.length?b.each(function(){c=g(this);a.push(c.attr("name")+"="+c.val())}):g(this).children().each(function(){e=g(this);a.push(e.attr("name")+"="+e.val())});
return a.join("&")},destroy:function(){g.data(this.container.get(0),"twzipcode",null);if(this.container.length)return this.container.empty().off("change.twzipcode keyup.twzipcode blur.twzipcode")},get:function(a){if("function"===typeof a)a.call(this,this.wrap);else if("string"===typeof a){if("undefined"!==typeof this.wrap[a])return this.wrap[a].val()}else return this.wrap},set:function(a){var b=g.extend({},{county:"",district:"",zipcode:""},a);try{"string"===typeof a||"number"===typeof a?this.wrap.zipcode.val(a).trigger("blur.twzipcode"):
(b.zipcode&&this.wrap.zipcode.val(b.zipcode).trigger("blur.twzipcode"),b.county&&this.wrap.county.val(b.county).trigger("change.twzipcode"),b.district&&this.wrap.district.val(b.district).trigger("change.twzipcode"))}catch(c){console.warn(c.message)}finally{return this.container}},reset:function(a,b){var c=this.wrap,f=this.options,d="",k=[];switch(b){case "district":c.district.html('<option value="">\u9109\u93ae\u5e02\u5340</option>');break;default:c.county.html('<option value="">\u7e23\u5e02</option>');
c.district.html('<option value="">\u9109\u93ae\u5e02\u5340</option>');for(d in e)"undefined"!==typeof e[d]&&-1===f.hideCounty.indexOf(d)&&k.push('<option value="'+d+'">'+d+"</option>");g(k.join("")).appendTo(c.county)}c.zipcode.val("")},bindings:function(){var a=this,b=a.options,c=a.wrap,f="",d="",k="";c.county.on("change.twzipcode",function(){var h=g(this).val(),d="",f=[];c.district.empty();if(h){if(!0===b.zipcodeIntoDistrict)for(d in e[h])"undefined"!==typeof e[h][d]&&-1===b.hideDistrict.indexOf(d)&&
-1===b.hideDistrict.indexOf(e[h][d])&&(f.push('<option value="'+d+'">'),f.push(e[h][d]+" "+d),f.push("</option>"));else for(d in e[h])"undefined"!==typeof e[h][d]&&-1===b.hideDistrict.indexOf(d)&&-1===b.hideDistrict.indexOf(e[h][d])&&(f.push('<option value="'+d+'">'),f.push(d),f.push("</option>"));c.district.append(f.join("")).trigger("change.twzipcode")}else c.county.find("option:first").prop("selected",!0),a.reset("district");"function"===typeof b.onCountySelect&&b.onCountySelect.call(this)});c.district.on("change.twzipcode",
function(){var a=g(this).val();c.county.val()&&c.zipcode.val(e[c.county.val()][a]);"function"===typeof b.onDistrictSelect&&b.onDistrictSelect.call(this)});c.zipcode.on("keyup.twzipcode blur.twzipcode",function(){var a=g(this),d="",f="";a.val(a.val().replace(/[^0-9]/g,""));a=a.val().toString();if(3===a.length)for(d in e)if("undefined"!==typeof e[d])for(f in e[d])if("undefined"!==typeof e[d][f]&&a===e[d][f]){c.county.val(d).trigger("change.twzipcode");c.district.val(f).trigger("change.twzipcode");break}"function"===
typeof b.onZipcodeKeyUp&&b.onZipcodeKeyUp.call(this)});f="undefined"!==typeof b.zipcodeSel?b.zipcodeSel:"undefined"!==typeof a.role.zipcode.data("value")?a.role.zipcode.data("value"):b.zipcodeSel;d="undefined"!==typeof b.countySel?b.countySel:"undefined"!==typeof a.role.county.data("value")?a.role.county.data("value"):b.countySel;k="undefined"!==typeof b.districtSel?b.districtSel:"undefined"!==typeof a.role.district.data("value")?a.role.district.data("value"):b.districtSel;d&&(a.wrap.county.val(d).trigger("change.twzipcode"),
"undefined"!==typeof e[d][k]&&a.wrap.district.val(k).trigger("change.twzipcode"));f&&3===f.toString().length&&a.wrap.zipcode.val(f).trigger("blur.twzipcode")},geoLocation:function(a){var b=this,c=navigator.geolocation,f=b.options;c&&a&&c.getCurrentPosition(function(c){var d={};"coords"in c&&"latitude"in c.coords&&"longitude"in c.coords&&(d=[c.coords.latitude,c.coords.longitude],g.getJSON("https://maps.googleapis.com/maps/api/geocode/json",{key:f.googleMapsKey,sensor:!1,latlng:d.join(",")},function(d){d&&
"undefined"!==typeof d.results&&"undefined"!==typeof d.results[0].address_components&&"undefined"!==typeof d.results[0].address_components[0]&&(d=d.results[0].address_components[d.results[0].address_components.length-1].long_name)&&b.wrap.zipcode.val(d.toString()).trigger("blur.twzipcode");"function"===typeof a&&a.call(b,c)}))},function(a){console.error(a)},{maximumAge:6E5,timeout:3E3,enableHighAccuracy:!1})},init:function(){var a=this.container,b=this.options,c={county:a.find("[data-role=county]:first"),
district:a.find("[data-role=district]:first"),zipcode:a.find("[data-role=zipcode]:first")},f=c.county.data("name")||b.countyName,d=c.district.data("name")||b.districtName,e=c.zipcode.data("name")||b.zipcodeName,h=c.zipcode.data("placeholder")||b.zipcodePlaceholder,l=c.zipcode.data("readonly")||b.readonly;g("<select/>").attr("name",f).addClass(c.county.data("style")||("undefined"!==typeof b.css[0]?b.css[0]:"")).appendTo(c.county.length?c.county:a);g("<select/>").attr("name",d).addClass(c.district.data("style")||
("undefined"!==typeof b.css[1]?b.css[1]:"")).appendTo(c.district.length?c.district:a);g("<input/>").attr({type:"text",name:e,placeholder:h}).prop("readonly",l).addClass(c.zipcode.data("style")||("undefined"!==typeof b.css[2]?b.css[2]:"")).appendTo(c.zipcode.length?c.zipcode:a);this.wrap={county:a.find('select[name="'+f+'"]:first'),district:a.find('select[name="'+d+'"]:first'),zipcode:a.find('input[type=text][name="'+e+'"]:first')};!0===b.zipcodeIntoDistrict&&this.wrap.zipcode.hide();this.role=c;this.reset();
this.bindings();this.geoLocation(b.detect)}};g.fn.twzipcode=function(a){var b={},c=[],e=arguments;return"string"===typeof a?(this.each(function(){b=g.data(this,"twzipcode");b instanceof l&&"function"===typeof b[a]&&(c=b[a].apply(b,Array.prototype.slice.call(e,1)))}),"undefined"!==typeof c?c:this):this.each(function(){g.data(this,"twzipcode")||g.data(this,"twzipcode",new l(this,a))})}})(window.jQuery||{},window,document);
